...
\subsection{1.1 Contexte de l'Analyse}\label{contexte-de-lanalyse}}
...
\subsection{1.2 Objectif de l'Analyse}\label{objectif-de-lanalyse}}
...
\subsection{1.3 Méthodologie d'Analyse}\label{muxe9thodologie-danalyse}}
...
\section{CHAPITRE 2 : VISION PRODUIT}\label{chapitre-2-vision-produit}}

\hypertarget{vision-produit}{%
\subsection{2.1 Vision Produit}\label{vision-produit}}
...
\subsection{2.2 Justification de la Vision
...
\subsection{2.3 Objectifs du Système}\label{objectifs-du-systuxe8me}}
...
\subsection{2.4 Périmètre Fonctionnel de
...
\section{CHAPITRE 3 : IDENTIFICATION DES
...
\subsection{3.2 Agriculteur}\label{agriculteur}}
...
\subsection{3.3 Agronome}\label{agronome}}
...
\subsubsection{Responsabilités}\label{responsabilituxe9s-1}}
...
\subsection{3.4 Administrateur}\label{administrateur}}
...
\subsubsection{Responsabilités}\label{responsabilituxe9s-2}}
...
\subsection{3.5 Service de Prédiction}\label{service-de-pruxe9diction}}
...
\subsubsection{Responsabilités}\label{responsabilituxe9s-3}}
...
\subsection{3.6 Synthèse des Acteurs}\label{synthuxe8se-des-acteurs}}
...
\section{CHAPITRE 4 : IDENTIFICATION DES CAS
...
\subsection{4.2 Cas d'Utilisation de
...
\subsubsection{CU1 : S'authentifier}\label{cu1-sauthentifier}}

Permet à l'agriculteur d'accéder aux fonctionnalités du système.

\hypertarget{cu2-guxe9rer-les-cultures}{%
\subsubsection{CU2 : Gérer les
cultures}\label{cu2-guxe9rer-les-cultures}}
...
\subsubsection{CU3 : Suivre les
cultures}\label{cu3-suivre-les-cultures}}
...
\subsubsection{CU4 : Obtenir une prédiction de
...
\subsubsection{CU5 : Obtenir des recommandations
...
\subsection{4.3 Cas d'Utilisation de
...
\subsubsection{CU1 : S'authentifier}\label{cu1-sauthentifier-1}}

\hypertarget{cu3-suivre-les-cultures-1}{%
\subsubsection{CU3 : Suivre les
cultures}\label{cu3-suivre-les-cultures-1}}
...
\subsection{4.4 Cas d'Utilisation de
...
\subsubsection{CU1 : S'authentifier}\label{cu1-sauthentifier-2}}

\hypertarget{cu6-guxe9rer-les-utilisateurs}{%
\subsubsection{CU6 : Gérer les
...
\subsubsection{CU7 : Administrer le
...
\subsection{4.5 Cas d'Utilisation du Service de
...
\subsubsection{CU8 : Fournir une prédiction de
...
\subsection{4.6 Correspondance entre les Exigences Fonctionnelles et les
Cas
...
\subsection{4.7 Synthèse des Cas
...
\section{CHAPITRE 5 : DIAGRAMME DE CAS
...
\subsection{5.2 Acteurs du Diagramme}\label{acteurs-du-diagramme}}
...
\subsection{5.3 Cas d'Utilisation du
...
\subsection{5.4 Relations du Diagramme}\label{relations-du-diagramme}}

\hypertarget{relations-dassociation}{%
\subsubsection{Relations d'Association}\label{relations-dassociation}}

Les associations entre acteurs et cas d'utilisation sont les suivantes :

\hypertarget{agriculteur-1}{%
\paragraph{Agriculteur}\label{agriculteur-1}}
...
\paragraph{Agronome}\label{agronome-1}}
...
\paragraph{Administrateur}\label{administrateur-1}}
...
\paragraph{Service de Prédiction}\label{service-de-pruxe9diction-1}}
...
\subsubsection{Relations d'Inclusion (« include
...
\subsubsection{Relations d'Extension (« extend
...
\subsection{5.5 Diagramme de Cas
...
\includegraphics[width=6.69306in,height=7.51875in]{media/media/image1.png}

\hypertarget{conclusion}{%
\subsection{5.6 Conclusion}\label{conclusion}}
...
\section{CHAPITRE 6 : DESCRIPTION DÉTAILLÉE DES CAS
...
\subsection{6.1 Cas d'Utilisation CU1 :
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs}}

\hypertarget{sa1-informations-dauthentification-incorrectes}{%
\paragraph{SA1 : Informations d'authentification
...
\paragraph{SA2 : Compte inexistant}\label{sa2-compte-inexistant}}
...
\subsection{6.2 Cas d'Utilisation CU2 : Gérer les
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal-1}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs-1}}

\hypertarget{sa1-informations-incompluxe8tes}{%
\paragraph{SA1 : Informations
...
\paragraph{SA2 : Culture inexistante}\label{sa2-culture-inexistante}}
...
\subsection{6.3 Cas d'Utilisation CU3 : Suivre les
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal-2}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs-2}}

\hypertarget{sa1-culture-inexistante}{%
\paragraph{SA1 : Culture inexistante}\label{sa1-culture-inexistante}}
...
\paragraph{SA2 : Informations d'observation
...
\subsection{6.4 Cas d'Utilisation CU4 : Obtenir une Prédiction de
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal-3}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs-3}}

\hypertarget{sa1-culture-inexistante-1}{%
\paragraph{SA1 : Culture inexistante}\label{sa1-culture-inexistante-1}}
...
\subsection{6.5 Cas d'Utilisation CU5 : Obtenir des Recommandations
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal-4}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs-4}}

\hypertarget{sa1-culture-inexistante-2}{%
\paragraph{SA1 : Culture inexistante}\label{sa1-culture-inexistante-2}}
...
\paragraph{SA3 : Aucune recommandation
...
\subsection{6.6 Cas d'Utilisation CU6 : Gérer les
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal-5}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs-5}}
...
\subsection{6.7 Cas d'Utilisation CU7 : Administrer le
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal-6}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs-6}}
...
\subsection{6.8 Cas d'Utilisation CU8 : Fournir une Prédiction de
...
\subsubsection{Scénario Nominal}\label{scuxe9nario-nominal-7}}
...
\subsubsection{Scénarios Alternatifs}\label{scuxe9narios-alternatifs-7}}
...
\paragraph{SA2 : Échec du traitement}\label{sa2-uxe9chec-du-traitement}}
...
\section{CHAPITRE 7 : DIAGRAMMES DE SÉQUENCE
SYSTÈME}\label{chapitre-7-diagrammes-de-suxe9quence-systuxe8me}}

\hypertarget{introduction-3}{%
\subsection{7.1 Introduction}\label{introduction-3}}
...
\subsection{7.2 Diagramme de Séquence Système du Cas d'Utilisation CU1 :
...
\includegraphics[width=5.375in,height=3.53125in]{media/media/image2.png}

\textbf{Figure 7.1 : Diagramme de séquence système du cas d'utilisation
« S'authentifier »}

\hypertarget{diagramme-de-suxe9quence-systuxe8me-du-cas-dutilisation-cu2-guxe9rer-les-cultures}{%
\subsection{7.3 Diagramme de Séquence Système du Cas d'Utilisation CU2 :
Gérer les
...
\includegraphics[width=4.97917in,height=4.14583in]{media/media/image3.png}

\textbf{Figure 7.2 : Diagramme de séquence système du cas d'utilisation
« Gérer les cultures »}

\hypertarget{diagramme-de-suxe9quence-systuxe8me-du-cas-dutilisation-cu3-suivre-les-cultures}{%
\subsection{7.4 Diagramme de Séquence Système du Cas d'Utilisation CU3 :
Suivre les
...
\includegraphics[width=6.69306in,height=3.59931in]{media/media/image4.png}

\textbf{Figure 7.3 : Diagramme de séquence système du cas d'utilisation
« Suivre les cultures »}

\hypertarget{diagramme-de-suxe9quence-systuxe8me-du-cas-dutilisation-cu4-obtenir-une-pruxe9diction-de-rendement}{%
\subsection{7.5 Diagramme de Séquence Système du Cas d'Utilisation CU4 :
...
\includegraphics[width=6.41667in,height=4.10417in]{media/media/image5.png}

\textbf{Figure 7.4 : Diagramme de séquence système du cas d'utilisation
« Obtenir une prédiction de rendement »}

\hypertarget{diagramme-de-suxe9quence-systuxe8me-du-cas-dutilisation-cu5-obtenir-des-recommandations-agronomiques}{%
\subsection{7.6 Diagramme de Séquence Système du Cas d'Utilisation CU5 :
...
\includegraphics[width=6.69306in,height=3.34653in]{media/media/image6.png}

\textbf{Figure 7.5 : Diagramme de séquence système du cas d'utilisation
« Obtenir des recommandations agronomiques »}

\hypertarget{diagramme-de-suxe9quence-systuxe8me-du-cas-dutilisation-cu6-guxe9rer-les-utilisateurs}{%
\subsection{7.7 Diagramme de Séquence Système du Cas d'Utilisation CU6 :
Gérer les
...
\includegraphics[width=5.27083in,height=4.14583in]{media/media/image7.png}

\textbf{Figure 7.6 : Diagramme de séquence système du cas d'utilisation
« Gérer les utilisateurs »}

\hypertarget{diagramme-de-suxe9quence-systuxe8me-du-cas-dutilisation-cu7-administrer-le-systuxe8me}{%
\subsection{7.8 Diagramme de Séquence Système du Cas d'Utilisation CU7 :
Administrer le
...
\includegraphics[width=6.69306in,height=4.10417in]{media/media/image8.png}

\textbf{Figure 7.7 : Diagramme de séquence système du cas d'utilisation
« Administrer le système »}

\hypertarget{chapitre-8-conclusion}{%
\section{CHAPITRE 8 : CONCLUSION}\label{chapitre-8-conclusion}}
