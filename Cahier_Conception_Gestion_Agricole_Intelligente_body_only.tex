...
\section{Objectif de la Conception}\label{objectif-de-la-conception}}
...
\section{Démarche Adoptée}\label{duxe9marche-adoptuxe9e}}
...
\chapter{CHOIX DE L'ARCHITECTURE}\label{chapitre-2-choix-de-larchitecture}}
...
\section{Architecture Retenue}\label{architecture-retenue}}
...
\section{Principe de Fonctionnement}\label{principe-de-fonctionnement}}
...
\chapter{DIAGRAMME DE PAQUETAGES}\label{chapitre-3-diagramme-de-paquetages}}
...
\section{Identification des Paquetages}\label{identification-des-paquetages}}
...
\section{Relations entre les Paquetages}\label{relations-entre-les-paquetages}}
...
\section{Diagramme de Paquetages}\label{diagramme-de-paquetages}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=2.51111in]{dpkg.png}
\caption{Diagramme de paquetages de l'application de gestion agricole intelligente}
\end{figure}


\hypertarget{chapitre-4-diagrammes-de-suxe9quence-de-conception}{%
\chapter{DIAGRAMMES DE SÉQUENCE DE CONCEPTION}\label{chapitre-4-diagrammes-de-suxe9quence-de-conception}}
...
\section{Diagramme de Séquence de Conception du Cas d'Utilisation CU1 : S'authentifier}\label{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu1-sauthentifier}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=3.21944in]{dsccu1.png}
\caption{Diagramme de séquence de conception : Authentification (CU1)}
\end{figure}

\hypertarget{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu2-guxe9rer-les-cultures}{%
\section{Diagramme de Séquence de Conception du Cas d'Utilisation CU2 : Gérer les Cultures}\label{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu2-guxe9rer-les-cultures}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=3.05903in]{dsccu2.png}
\caption{Diagramme de séquence de conception : Gestion des cultures (CU2)}
\end{figure}

\hypertarget{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu3-suivre-les-cultures}{%
\section{Diagramme de Séquence de Conception du Cas d'Utilisation CU3 : Suivre les Cultures}\label{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu3-suivre-les-cultures}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=3.48681in]{dsccu3.png}
\caption{Diagramme de séquence de conception : Suivi des cultures (CU3)}
\end{figure}

\hypertarget{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu4-obtenir-une-pruxe9diction-de-rendement}{%
\section{Diagramme de Séquence de Conception du Cas d'Utilisation CU4 : Obtenir une Prédiction de Rendement}\label{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu4-obtenir-une-pruxe9diction-de-rendement}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=3.34028in]{dsccu4.png}
\caption{Diagramme de séquence de conception : Prédiction de rendement (CU4)}
\end{figure}

\hypertarget{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu5-obtenir-des-recommandations-agronomiques}{%
\section{Diagramme de Séquence de Conception du Cas d'Utilisation CU5 : Obtenir des Recommandations Agronomiques}\label{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu5-obtenir-des-recommandations-agronomiques}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=3.04792in]{dsccu5.png}
\caption{Diagramme de séquence de conception : Recommandations agronomiques (CU5)}
\end{figure}

\hypertarget{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu6-guxe9rer-les-utilisateurs}{%
\section{Diagramme de Séquence de Conception du Cas d'Utilisation CU6 : Gérer les Utilisateurs}\label{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu6-guxe9rer-les-utilisateurs}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=2.99583in]{dsccu6.png}
\caption{Diagramme de séquence de conception : Gestion des utilisateurs (CU6)}
\end{figure}

\hypertarget{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu7-administrer-le-systuxe8me}{%
\section{Diagramme de Séquence de Conception du Cas d'Utilisation CU7 : Administrer le Système}\label{diagramme-de-suxe9quence-de-conception-du-cas-dutilisation-cu7-administrer-le-systuxe8me}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=3.20278in]{dsccu7.png}
\caption{Diagramme de séquence de conception : Administration du système (CU7)}
\end{figure}

\hypertarget{chapitre-5-diagramme-de-classes}{%
\chapter{DIAGRAMME DE CLASSES}\label{chapitre-5-diagramme-de-classes}}
...
\section{Diagramme de Classes}\label{diagramme-de-classes}}
 
\begin{figure}[H]
\centering
\includegraphics[width=5.49444in,height=5.41806in]{dc.png}
\caption{Diagramme de classes}
\end{figure}

Le diagramme de classes suivant représente la structure statique de
...
\chapter{MODÈLE DE DONNÉES}\label{chapitre-6-moduxe8le-de-donnuxe9es}}
...
\section{Passage du Diagramme de Classes au Modèle Relationnel}\label{passage-du-diagramme-de-classes-au-moduxe8le-relationnel}}
...
\section{Schéma Relationnel Global}\label{schuxe9ma-relationnel-global}}
...
\section{Diagramme Relationnel de la Base de Données}\label{diagramme-relationnel-de-la-base-de-donnuxe9es}}
...
\begin{figure}[H]
\centering
\includegraphics[width=6.69306in,height=5.07361in]{mcd.png}
\caption{Schéma relationnel global de la base de données}
\end{figure}
...
\section{Conclusion}\label{chapitre-7-conclusion}}
